...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('level', sa.Enum('BASIC', 'INTERMEDIATE', 'CNC', name='traininglevel'), nullable=True),
    ...
    sa.Column('tool_level', sa.Enum('BASIC', 'INTERMEDIATE', 'CNC', name='traininglevel'), nullable=True),
    sa.ForeignKeyConstraint(['tool_id'], ['tool.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
